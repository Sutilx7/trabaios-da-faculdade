...
Visualização de Estoque: Lista todos os produtos com Código, Nome, Quantidade e Preço Unitário.

Adicionar Produto: Permite cadastrar um novo item no estoque.
...
python inventario_de_supermercado.py
...
Credenciais de Login (no código):

Campo	Valor
Usuário Correto	backup22
Senha Correta	151515
